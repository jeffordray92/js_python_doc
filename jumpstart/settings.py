...
TEMPLATE_CONTEXT_PROCESSORS = [
    ...
    "jumpstart.context_processors.site_settings",
]
...
TEMPLATE_DIRS = (
    os.path.join(BASE_DIR, TEMPLATE_URL.strip('/')),
)

# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = '*j&3ag+@63qove8k5-1-yv+jjzcjuba6!c&v)u2xheufk(6zwh'
