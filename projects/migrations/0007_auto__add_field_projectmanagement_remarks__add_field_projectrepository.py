...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectManagement.remarks'
        db.add_column(u'projects_projectmanagement', 'remarks',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)

        # Adding field 'ProjectRepository.remarks'
        db.add_column(u'projects_projectrepository', 'remarks',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)

        # Adding field 'ProjectTestSite.remarks'
        db.add_column(u'projects_projecttestsite', 'remarks',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProjectManagement.remarks'
        db.delete_column(u'projects_projectmanagement', 'remarks')

        # Deleting field 'ProjectRepository.remarks'
        db.delete_column(u'projects_projectrepository', 'remarks')

        # Deleting field 'ProjectTestSite.remarks'
        db.delete_column(u'projects_projecttestsite', 'remarks')
